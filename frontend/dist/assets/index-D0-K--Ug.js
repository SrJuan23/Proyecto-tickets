var So=Object.defineProperty;var Co=(s,t,e)=>t in s?So(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var x=(s,t,e)=>Co(s,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function e(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(n){if(n.ep)return;n.ep=!0;const o=e(n);fetch(n.href,o)}})();const cs="/api";class Mo{constructor(){x(this,"token",null);x(this,"currentUser",null);this.token=localStorage.getItem("token");const t=localStorage.getItem("user");if(t)try{this.currentUser=JSON.parse(t)}catch{this.currentUser=null}}getToken(){return this.token}getUser(){return this.currentUser}setAuth(t,e){this.token=t,this.currentUser=e,localStorage.setItem("token",t),localStorage.setItem("user",JSON.stringify(e)),window.dispatchEvent(new CustomEvent("auth-changed",{detail:{user:e}}))}clearAuth(){this.token=null,this.currentUser=null,localStorage.removeItem("token"),localStorage.removeItem("user"),window.dispatchEvent(new CustomEvent("auth-changed",{detail:{user:null}}))}hasRole(...t){return this.currentUser?t.includes(this.currentUser.rol):!1}async request(t,e={}){const i={"Content-Type":"application/json",...e.headers||{}};this.token&&(i.Authorization=`Bearer ${this.token}`);try{const n=await fetch(`${cs}${t}`,{...e,headers:i});n.status===401&&this.token&&this.clearAuth();const o=await n.json();if(!n.ok)throw new Error(o.message||`Error HTTP ${n.status}`);return o}catch(n){throw console.error(`[API ERROR] ${t}:`,n),n}}async login(t,e){const i=await this.request("/auth/login",{method:"POST",body:JSON.stringify({email:t,password:e})});return i.data&&this.setAuth(i.data.token,i.data.user),i}async getMe(){return this.request("/auth/me")}async getDemoAccounts(){return this.request("/auth/demo-accounts")}async getTickets(t={}){const e=new URLSearchParams;return Object.entries(t).forEach(([i,n])=>{n!=null&&n!==""&&e.append(i,String(n))}),this.request(`/tickets?${e.toString()}`)}async getTicket(t){return this.request(`/tickets/${t}`)}async createTicket(t){return this.request("/tickets",{method:"POST",body:JSON.stringify(t)})}async updateTicket(t,e){return this.request(`/tickets/${t}`,{method:"PUT",body:JSON.stringify(e)})}async changeTicketStatus(t,e){return this.request(`/tickets/${t}/estado`,{method:"PATCH",body:JSON.stringify({estado:e})})}async toggleTicketStatus(t){return this.request(`/tickets/${t}/toggle-status`,{method:"PATCH"})}async deleteTicket(t){return this.request(`/tickets/${t}`,{method:"DELETE"})}async getClients(t,e){const i=new URLSearchParams;return t&&i.append("search",t),e&&i.append("estado",e),this.request(`/clientes?${i.toString()}`)}async createClient(t){return this.request("/clientes",{method:"POST",body:JSON.stringify(t)})}async updateClient(t,e){return this.request(`/clientes/${t}`,{method:"PUT",body:JSON.stringify(e)})}async toggleClientStatus(t){return this.request(`/clientes/${t}/toggle-status`,{method:"PATCH"})}async deleteClient(t){return this.request(`/clientes/${t}`,{method:"DELETE"})}async getPlatforms(t,e){const i=new URLSearchParams;return t&&i.append("search",t),e&&i.append("estado",e),this.request(`/plataformas?${i.toString()}`)}async createPlatform(t){return this.request("/plataformas",{method:"POST",body:JSON.stringify(t)})}async updatePlatform(t,e){return this.request(`/plataformas/${t}`,{method:"PUT",body:JSON.stringify(e)})}async togglePlatformStatus(t){return this.request(`/plataformas/${t}/toggle-status`,{method:"PATCH"})}async deletePlatform(t){return this.request(`/plataformas/${t}`,{method:"DELETE"})}async getAgents(t,e){const i=new URLSearchParams;return t&&i.append("search",t),e&&i.append("estado",e),this.request(`/agentes?${i.toString()}`)}async getKPIs(){return this.request("/stats/kpis")}async getCharts(t="30d",e,i){const n=new URLSearchParams({periodo:t});return e&&n.append("fecha_desde",e),i&&n.append("fecha_hasta",i),this.request(`/stats/charts?${n.toString()}`)}async getConfig(){return this.request("/config")}async updateConfig(t,e,i){return this.request(`/config/${t}`,{method:"PUT",body:JSON.stringify({valor:e,descripcion:i})})}async getUsers(){return this.request("/usuarios")}async createUser(t){return this.request("/usuarios",{method:"POST",body:JSON.stringify(t)})}async updateUser(t,e){return this.request(`/usuarios/${t}`,{method:"PUT",body:JSON.stringify(e)})}async deleteUser(t){return this.request(`/usuarios/${t}`,{method:"DELETE"})}async toggleUserStatus(t){return this.request(`/usuarios/${t}/toggle-status`,{method:"PATCH"})}getExportUrl(t,e={}){const i=new URLSearchParams;return Object.entries(e).forEach(([n,o])=>{o!=null&&o!==""&&i.append(n,String(o))}),`${cs}/export/${t}?${i.toString()}`}async downloadExport(t,e={}){const i=this.token||localStorage.getItem("token");if(!i)throw new Error("Debes iniciar sesión para exportar reportes.");const n=new URLSearchParams;Object.entries(e).forEach(([f,p])=>{p!=null&&p!==""&&n.append(f,String(p))});const o=await fetch(`${cs}/export/${t}?${n.toString()}`,{headers:{Authorization:`Bearer ${i}`}});if(!o.ok){let f="Error al generar el archivo.";try{f=(await o.clone().json()).message||f}catch{const p=await o.text();p&&(f=p)}throw new Error(f)}const r=(o.headers.get("content-disposition")||"").match(/filename\s*=\s*"?([^";]+)"?/i),c=r?r[1]:`reporte.${t==="excel"?"xlsx":"csv"}`,d=await o.blob(),h=URL.createObjectURL(d),u=document.createElement("a");u.href=h,u.download=c,document.body.appendChild(u),u.click(),u.remove(),URL.revokeObjectURL(h)}}const M=new Mo;class Eo{constructor(t,e){x(this,"container");x(this,"currentRoute","dashboard");x(this,"isCollapsed",!1);x(this,"onNavigate");this.container=t,this.onNavigate=e,this.isCollapsed=localStorage.getItem("sidebar_collapsed")==="true"}setRoute(t){this.currentRoute=t,this.render()}toggleCollapse(){this.isCollapsed=!this.isCollapsed,localStorage.setItem("sidebar_collapsed",String(this.isCollapsed)),this.render(),window.dispatchEvent(new CustomEvent("sidebar-toggled",{detail:{collapsed:this.isCollapsed}}))}render(){M.getUser();const t=M.hasRole("ADMIN"),e=M.hasRole("AGENTE"),i=M.hasRole("CONSULTA"),o=[{id:"dashboard",label:"Dashboard",icon:this.getDashboardIcon()},{id:"tickets",label:"Casos",icon:this.getTicketsIcon()},{id:"clients",label:"Clientes",icon:this.getClientsIcon(),adminOrAgent:!0},{id:"platforms",label:"Plataformas",icon:this.getPlatformsIcon(),adminOrAgent:!0},{id:"agents",label:"Agentes",icon:this.getAgentsIcon(),adminOrAgent:!0},{id:"reports",label:"Reportes",icon:this.getReportsIcon(),adminOrAgentOrConsulta:!0},{id:"settings",label:"Configuración",icon:this.getSettingsIcon(),adminOnly:!0}].filter(c=>c.adminOnly?t:c.adminOrAgent?t||e:c.adminOrAgentOrConsulta?t||e||i:!0);this.container.className=`fixed inset-y-0 left-0 z-30 flex flex-col bg-brand-dark text-slate-200 transition-all duration-300 shadow-xl lg:static lg:translate-x-0 ${this.isCollapsed?"w-20":"w-64"}`,this.container.innerHTML=`
      ...
      <div class="flex items-center gap-3">
        ...
        ${t?`
          <div class="hidden md:flex items-center gap-2 text-xs font-lato text-slate-600">
            ...
            <span class="font-montserrat font-bold text-slate-800">${t.nombre}</span>
            <span class="px-2 py-0.5 rounded-full text-[10px] font-bold font-montserrat bg-brand-primary-light text-brand-primary">${t.rol}</span>
          </div>
        `:""}
      </div>
    ...
    `;const i=this.container.querySelector("#header-new-ticket-btn");i==null||i.addEventListener("click",()=>this.onOpenNewTicket());const n=this.container.querySelector("#mobile-menu-btn");n==null||n.addEventListener("click",()=>this.onToggleMobileMenu());const o=this.container.querySelector("#header-login-btn");o==null||o.addEventListener("click",()=>this.onOpenLogin());const a=this.container.querySelector("#user-profile-btn"),r=this.container.querySelector("#user-dropdown");a==null||a.addEventListener("click",h=>{h.stopPropagation(),r==null||r.classList.toggle("hidden")}),document.addEventListener("click",h=>{!(r!=null&&r.contains(h.target))&&!(a!=null&&a.contains(h.target))&&(r==null||r.classList.add("hidden"))});const l=this.container.querySelector("#open-profile-btn");l==null||l.addEventListener("click",()=>{r==null||r.classList.add("hidden"),this.openProfileModal()});const c=this.container.querySelector("#switch-user-btn");c==null||c.addEventListener("click",()=>{r==null||r.classList.add("hidden"),M.clearAuth(),window.location.href="/login"});const d=this.container.querySelector("#logout-btn");d==null||d.addEventListener("click",()=>{M.clearAuth(),window.location.href="/login"})}openProfileModal(){var a,r;const t=M.getUser();if(!t)return;const e=document.getElementById("modal-container");if(!e)return;const i=document.createElement("div");i.className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-fade-in",i.innerHTML=`
      <div class="bg-white rounded-3xl max-w-md w-full shadow-modal border border-slate-100 overflow-hidden">
        ...
        <form id="profile-form" class="p-6 space-y-4 text-xs font-lato">
          <div>
            ...
            <input type="text" name="nombre" value="${t.nombre||""}" required class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none" />
          </div>
          <div>
            <label class="block font-montserrat font-semibold text-slate-700 mb-1">Correo electrónico *</label>
            <input type="email" name="email" value="${t.email||""}" required class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none" />
          </div>
          <div>
            <label class="block font-montserrat font-semibold text-slate-700 mb-1">Teléfono</label>
            <input type="text" name="telefono" value="${t.telefono||""}" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none" />
          </div>
          <div>
            <label class="block font-montserrat font-semibold text-slate-700 mb-1">Especialidad</label>
            <input type="text" name="especialidad" value="${t.especialidad||""}" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none" />
          </div>
...
`):s}function od(s,t){const{element:e,datasetIndex:i,index:n}=t,o=s.getDatasetMeta(i).controller,{label:a,value:r}=o.getLabelAndValue(n);return{chart:s,label:a,parsed:o.getParsed(n),raw:s.data.datasets[i].data[n],formattedValue:r,dataset:o.getDataset(),dataIndex:n,datasetIndex:i,element:e}}function dn(s,t){const e=s.chart.ctx,{body:i,footer:n,title:o}=s,{boxWidth:a,boxHeight:r}=t,l=U(t.bodyFont),c=U(t.titleFont),d=U(t.footerFont),h=o.length,u=n.length,f=i.length,p=Q(t.padding);let g=p.height,b=0,m=i.reduce((k,y)=>k+y.before.length+y.lines.length+y.after.length,0);if(m+=s.beforeBody.length+s.afterBody.length,h&&(g+=h*c.lineHeight+(h-1)*t.titleSpacing+t.titleMarginBottom),m){const k=t.displayColors?Math.max(r,l.lineHeight):l.lineHeight;g+=f*k+(m-f)*l.lineHeight+(m-1)*t.bodySpacing}u&&(g+=t.footerMarginTop+u*d.lineHeight+(u-1)*t.footerSpacing);let v=0;const w=function(k){b=Math.max(b,e.measureText(k).width+v)};return e.save(),e.font=c.string,$(s.title,w),e.font=l.string,$(s.beforeBody.concat(s.afterBody),w),v=t.displayColors?a+2+t.boxPadding:0,$(i,k=>{$(k.before,w),$(k.lines,w),$(k.after,w)}),v=0,e.font=d.string,$(s.footer,w),e.restore(),b+=p.width,{width:b,height:g}}function ad(s,t){const{y:e,height:i}=t;return e<i/2?"top":e>s.height-i/2?"bottom":"center"}function rd(s,t,e,i){const{x:n,width:o}=i,a=e.caretSize+e.caretPadding;if(s==="left"&&n+o+a>t.width||s==="right"&&n-o-a<0)return!0}function ld(s,t,e,i){const{x:n,width:o}=e,{width:a,chartArea:{left:r,right:l}}=s;let c="center";return i==="center"?c=n<=(r+l)/2?"left":"right":n<=o/2?c="left":n>=a-o/2&&(c="right"),rd(c,s,t,e)&&(c="center"),c}function hn(s,t,e){const i=e.yAlign||t.yAlign||ad(s,e);return{xAlign:e.xAlign||t.xAlign||ld(s,t,e,i),yAlign:i}}function cd(s,t){let{x:e,width:i}=s;return t==="right"?e-=i:t==="center"&&(e-=i/2),e}function dd(s,t,e){let{y:i,height:n}=s;return t==="top"?i+=e:t==="bottom"?i-=n+e:i-=n/2,i}function un(s,t,e,i){const{caretSize:n,caretPadding:o,cornerRadius:a}=s,{xAlign:r,yAlign:l}=e,c=n+o,{topLeft:d,topRight:h,bottomLeft:u,bottomRight:f}=Nt(a);let p=cd(t,r);const g=dd(t,l,c);return l==="center"?r==="left"?p+=c:r==="right"&&(p-=c):r==="left"?p-=Math.max(d,u)+n:r==="right"&&(p+=Math.max(h,f)+n),{x:Y(p,0,i.width-t.width),y:Y(g,0,i.height-t.height)}}function Fe(s,t,e){const i=Q(e.padding);return t==="center"?s.x+s.width/2:t==="right"?s.x+s.width-i.right:s.x+i.left}function fn(s){return dt([],gt(s))}function hd(s,t,e){return Tt(s,{tooltip:t,tooltipItems:e,type:"tooltip"})}function pn(s,t){const e=t&&t.dataset&&t.dataset.tooltip&&t.dataset.tooltip.callbacks;return e?s.override(e):s}const ko={beforeTitle:ft,title(s){if(s.length>0){const t=s[0],e=t.chart.data.labels,i=e?e.length:0;if(this&&this.options&&this.options.mode==="dataset")return t.dataset.label||"";if(t.label)return t.label;if(i>0&&t.dataIndex<i)return e[t.dataIndex]}return""},afterTitle:ft,beforeBody:ft,beforeLabel:ft,label(s){if(this&&this.options&&this.options.mode==="dataset")return s.label+": "+s.formattedValue||s.formattedValue;let t=s.dataset.label||"";t&&(t+=": ");const e=s.formattedValue;return P(e)||(t+=e),t},labelColor(s){const e=s.chart.getDatasetMeta(s.datasetIndex).controller.getStyle(s.dataIndex);return{borderColor:e.borderColor,backgroundColor:e.backgroundColor,borderWidth:e.borderWidth,borderDash:e.borderDash,borderDashOffset:e.borderDashOffset,borderRadius:0}},labelTextColor(){return this.options.bodyColor},labelPointStyle(s){const e=s.chart.getDatasetMeta(s.datasetIndex).controller.getStyle(s.dataIndex);return{pointStyle:e.pointStyle,rotation:e.rotation}},afterLabel:ft,afterBody:ft,beforeFooter:ft,footer:ft,afterFooter:ft};function tt(s,t,e,i){const n=s[t].call(e,i);return typeof n>"u"?ko[t].call(e,i):n}class Is extends ct{constructor(t){super(),this.opacity=0,this._active=[],this._eventPosition=void 0,this._size=void 0,this._cachedAnimations=void 0,this._tooltipItems=[],this.$animations=void 0,this.$context=void 0,this.chart=t.chart,this.options=t.options,this.dataPoints=void 0,this.title=void 0,this.beforeBody=void 0,this.body=void 0,this.afterBody=void 0,this.footer=void 0,this.xAlign=void 0,this.yAlign=void 0,this.x=void 0,this.y=void 0,this.height=void 0,this.width=void 0,this.caretX=void 0,this.caretY=void 0,this.labelColors=void 0,this.labelPointStyles=void 0,this.labelTextColors=void 0}initialize(t){this.options=t,this._cachedAnimations=void 0,this.$context=void 0}_resolveAnimations(){const t=this._cachedAnimations;if(t)return t;const e=this.chart,i=this.options.setContext(this.getContext()),n=i.enabled&&e.options.animation&&i.animations,o=new to(this.chart,n);return n._cacheable&&(this._cachedAnimations=Object.freeze(o)),o}getContext(){return this.$context||(this.$context=hd(this.chart.getContext(),this,this._tooltipItems))}getTitle(t,e){const{callbacks:i}=e,n=tt(i,"beforeTitle",this,t),o=tt(i,"title",this,t),a=tt(i,"afterTitle",this,t);let r=[];return r=dt(r,gt(n)),r=dt(r,gt(o)),r=dt(r,gt(a)),r}getBeforeBody(t,e){return fn(tt(e.callbacks,"beforeBody",this,t))}getBody(t,e){const{callbacks:i}=e,n=[];return $(t,o=>{const a={before:[],lines:[],after:[]},r=pn(i,o);dt(a.before,gt(tt(r,"beforeLabel",this,o))),dt(a.lines,tt(r,"label",this,o)),dt(a.after,gt(tt(r,"afterLabel",this,o))),n.push(a)}),n}getAfterBody(t,e){return fn(tt(e.callbacks,"afterBody",this,t))}getFooter(t,e){const{callbacks:i}=e,n=tt(i,"beforeFooter",this,t),o=tt(i,"footer",this,t),a=tt(i,"afterFooter",this,t);let r=[];return r=dt(r,gt(n)),r=dt(r,gt(o)),r=dt(r,gt(a)),r}_createItems(t){const e=this._active,i=this.chart.data,n=[],o=[],a=[];let r=[],l,c;for(l=0,c=e.length;l<c;++l)r.push(od(this.chart,e[l]));return t.filter&&(r=r.filter((d,h,u)=>t.filter(d,h,u,i))),t.itemSort&&(r=r.sort((d,h)=>t.itemSort(d,h,i))),$(r,d=>{const h=pn(t.callbacks,d);n.push(tt(h,"labelColor",this,d)),o.push(tt(h,"labelPointStyle",this,d)),a.push(tt(h,"labelTextColor",this,d))}),this.labelColors=n,this.labelPointStyles=o,this.labelTextColors=a,this.dataPoints=r,r}update(t,e){const i=this.options.setContext(this.getContext()),n=this._active;let o,a=[];if(!n.length)this.opacity!==0&&(o={opacity:0});else{const r=le[i.position].call(this,n,this._eventPosition);a=this._createItems(i),this.title=this.getTitle(a,i),this.beforeBody=this.getBeforeBody(a,i),this.body=this.getBody(a,i),this.afterBody=this.getAfterBody(a,i),this.footer=this.getFooter(a,i);const l=this._size=dn(this,i),c=Object.assign({},r,l),d=hn(this.chart,i,c),h=un(i,c,d,this.chart);this.xAlign=d.xAlign,this.yAlign=d.yAlign,o={opacity:1,x:h.x,y:h.y,width:l.width,height:l.height,caretX:r.x,caretY:r.y}}this._tooltipItems=a,this.$context=void 0,o&&this._resolveAnimations().update(this,o),t&&i.external&&i.external.call(this,{chart:this.chart,tooltip:this,replay:e})}drawCaret(t,e,i,n){const o=this.getCaretPosition(t,i,n);e.lineTo(o.x1,o.y1),e.lineTo(o.x2,o.y2),e.lineTo(o.x3,o.y3)}getCaretPosition(t,e,i){const{xAlign:n,yAlign:o}=this,{caretSize:a,cornerRadius:r}=i,{topLeft:l,topRight:c,bottomLeft:d,bottomRight:h}=Nt(r),{x:u,y:f}=t,{width:p,height:g}=e;let b,m,v,w,k,y;return o==="center"?(k=f+g/2,n==="left"?(b=u,m=b-a,w=k+a,y=k-a):(b=u+p,m=b+a,w=k-a,y=k+a),v=b):(n==="left"?m=u+Math.max(l,d)+a:n==="right"?m=u+p-Math.max(c,h)-a:m=this.caretX,o==="top"?(w=f,k=w-a,b=m-a,v=m+a):(w=f+g,k=w+a,b=m+a,v=m-a),y=w),{x1:b,x2:m,x3:v,y1:w,y2:k,y3:y}}drawTitle(t,e,i){const n=this.title,o=n.length;let a,r,l;if(o){const c=Yt(i.rtl,this.x,this.width);for(t.x=Fe(this,i.titleAlign,i),e.textAlign=c.textAlign(i.titleAlign),e.textBaseline="middle",a=U(i.titleFont),r=i.titleSpacing,e.fillStyle=i.titleColor,e.font=a.string,l=0;l<o;++l)e.fillText(n[l],c.x(t.x),t.y+a.lineHeight/2),t.y+=a.lineHeight+r,l+1===o&&(t.y+=i.titleMarginBottom-r)}}_drawColorBox(t,e,i,n,o){const a=this.labelColors[i],r=this.labelPointStyles[i],{boxHeight:l,boxWidth:c}=o,d=U(o.bodyFont),h=Fe(this,"left",o),u=n.x(h),f=l<d.lineHeight?(d.lineHeight-l)/2:0,p=e.y+f;if(o.usePointStyle){const g={radius:Math.min(c,l)/2,pointStyle:r.pointStyle,rotation:r.rotation,borderWidth:1},b=n.leftForLtr(u,c)+c/2,m=p+l/2;t.strokeStyle=o.multiKeyBackground,t.fillStyle=o.multiKeyBackground,Es(t,g,b,m),t.strokeStyle=a.borderColor,t.fillStyle=a.backgroundColor,Es(t,g,b,m)}else{t.lineWidth=D(a.borderWidth)?Math.max(...Object.values(a.borderWidth)):a.borderWidth||1,t.strokeStyle=a.borderColor,t.setLineDash(a.borderDash||[]),t.lineDashOffset=a.borderDashOffset||0;const g=n.leftForLtr(u,c),b=n.leftForLtr(n.xPlus(u,1),c-2),m=Nt(a.borderRadius);Object.values(m).some(v=>v!==0)?(t.beginPath(),t.fillStyle=o.multiKeyBackground,ve(t,{x:g,y:p,w:c,h:l,radius:m}),t.fill(),t.stroke(),t.fillStyle=a.backgroundColor,t.beginPath(),ve(t,{x:b,y:p+1,w:c-2,h:l-2,radius:m}),t.fill()):(t.fillStyle=o.multiKeyBackground,t.fillRect(g,p,c,l),t.strokeRect(g,p,c,l),t.fillStyle=a.backgroundColor,t.fillRect(b,p+1,c-2,l-2))}t.fillStyle=this.labelTextColors[i]}drawBody(t,e,i){const{body:n}=this,{bodySpacing:o,bodyAlign:a,displayColors:r,boxHeight:l,boxWidth:c,boxPadding:d}=i,h=U(i.bodyFont);let u=h.lineHeight,f=0;const p=Yt(i.rtl,this.x,this.width),g=function(C){e.fillText(C,p.x(t.x+f),t.y+u/2),t.y+=u+o},b=p.textAlign(a);let m,v,w,k,y,_,S;for(e.textAlign=a,e.textBaseline="middle",e.font=h.string,t.x=Fe(this,b,i),e.fillStyle=i.bodyColor,$(this.beforeBody,g),f=r&&b!=="right"?a==="center"?c/2+d:c+2+d:0,k=0,_=n.length;k<_;++k){for(m=n[k],v=this.labelTextColors[k],e.fillStyle=v,$(m.before,g),w=m.lines,r&&w.length&&(this._drawColorBox(e,t,k,p,i),u=Math.max(h.lineHeight,l)),y=0,S=w.length;y<S;++y)g(w[y]),u=h.lineHeight;$(m.after,g)}f=0,u=h.lineHeight,$(this.afterBody,g),t.y-=o}drawFooter(t,e,i){const n=this.footer,o=n.length;let a,r;if(o){const l=Yt(i.rtl,this.x,this.width);for(t.x=Fe(this,i.footerAlign,i),t.y+=i.footerMarginTop,e.textAlign=l.textAlign(i.footerAlign),e.textBaseline="middle",a=U(i.footerFont),e.fillStyle=i.footerColor,e.font=a.string,r=0;r<o;++r)e.fillText(n[r],l.x(t.x),t.y+a.lineHeight/2),t.y+=a.lineHeight+i.footerSpacing}}drawBackground(t,e,i,n){const{xAlign:o,yAlign:a}=this,{x:r,y:l}=t,{width:c,height:d}=i,{topLeft:h,topRight:u,bottomLeft:f,bottomRight:p}=Nt(n.cornerRadius);e.fillStyle=n.backgroundColor,e.strokeStyle=n.borderColor,e.lineWidth=n.borderWidth,e.beginPath(),e.moveTo(r+h,l),a==="top"&&this.drawCaret(t,e,i,n),e.lineTo(r+c-u,l),e.quadraticCurveTo(r+c,l,r+c,l+u),a==="center"&&o==="right"&&this.drawCaret(t,e,i,n),e.lineTo(r+c,l+d-p),e.quadraticCurveTo(r+c,l+d,r+c-p,l+d),a==="bottom"&&this.drawCaret(t,e,i,n),e.lineTo(r+f,l+d),e.quadraticCurveTo(r,l+d,r,l+d-f),a==="center"&&o==="left"&&this.drawCaret(t,e,i,n),e.lineTo(r,l+h),e.quadraticCurveTo(r,l,r+h,l),e.closePath(),e.fill(),n.borderWidth>0&&e.stroke()}_updateAnimationTarget(t){const e=this.chart,i=this.$animations,n=i&&i.x,o=i&&i.y;if(n||o){const a=le[t.position].call(this,this._active,this._eventPosition);if(!a)return;const r=this._size=dn(this,t),l=Object.assign({},a,this._size),c=hn(e,t,l),d=un(t,l,c,e);(n._to!==d.x||o._to!==d.y)&&(this.xAlign=c.xAlign,this.yAlign=c.yAlign,this.width=r.width,this.height=r.height,this.caretX=a.x,this.caretY=a.y,this._resolveAnimations().update(this,d))}}_willRender(){return!!this.opacity}draw(t){const e=this.options.setContext(this.getContext());let i=this.opacity;if(!i)return;this._updateAnimationTarget(e);const n={width:this.width,height:this.height},o={x:this.x,y:this.y};i=Math.abs(i)<.001?0:i;const a=Q(e.padding),r=this.title.length||this.beforeBody.length||this.body.length||this.afterBody.length||this.footer.length;e.enabled&&r&&(t.save(),t.globalAlpha=i,this.drawBackground(o,t,n,e),Xn(t,e.textDirection),o.y+=a.top,this.drawTitle(o,t,e),this.drawBody(o,t,e),this.drawFooter(o,t,e),Gn(t,e.textDirection),t.restore())}getActiveElements(){return this._active||[]}setActiveElements(t,e){const i=this._active,n=t.map(({datasetIndex:r,index:l})=>{const c=this.chart.getDatasetMeta(r);if(!c)throw new Error("Cannot find a dataset at index "+r);return{datasetIndex:r,element:c.data[l],index:l}}),o=!Xe(i,n),a=this._positionChanged(n,e);(o||a)&&(this._active=n,this._eventPosition=e,this._ignoreReplayEvents=!0,this.update(!0))}handleEvent(t,e,i=!0){if(e&&this._ignoreReplayEvents)return!1;this._ignoreReplayEvents=!1;const n=this.options,o=this._active||[],a=this._getActiveElements(t,o,e,i),r=this._positionChanged(a,t),l=e||!Xe(a,o)||r;return l&&(this._active=a,(n.enabled||n.external)&&(this._eventPosition={x:t.x,y:t.y},this.update(!0,e))),l}_getActiveElements(t,e,i,n){const o=this.options;if(t.type==="mouseout")return[];if(!n)return e.filter(r=>this.chart.data.datasets[r.datasetIndex]&&this.chart.getDatasetMeta(r.datasetIndex).controller.getParsed(r.index)!==void 0);const a=this.chart.getElementsAtEventForMode(t,o.mode,o,i);return o.reverse&&a.reverse(),a}_positionChanged(t,e){const{caretX:i,caretY:n,options:o}=this,a=le[o.position].call(this,t,e);return a!==!1&&(i!==a.x||n!==a.y)}}x(Is,"positioners",le);var ud={id:"tooltip",_element:Is,positioners:le,afterInit(s,t,e){e&&(s.tooltip=new Is({chart:s,options:e}))},beforeUpdate(s,t,e){s.tooltip&&s.tooltip.initialize(e)},reset(s,t,e){s.tooltip&&s.tooltip.initialize(e)},afterDraw(s){const t=s.tooltip;if(t&&t._willRender()){const e={tooltip:t};if(s.notifyPlugins("beforeTooltipDraw",{...e,cancelable:!0})===!1)return;t.draw(s.ctx),s.notifyPlugins("afterTooltipDraw",e)}},afterEvent(s,t){if(s.tooltip){const e=t.replay;s.tooltip.handleEvent(t.event,e,t.inChartArea)&&(t.changed=!0)}},defaults:{enabled:!0,external:null,position:"average",backgroundColor:"rgba(0,0,0,0.8)",titleColor:"#fff",titleFont:{weight:"bold"},titleSpacing:2,titleMarginBottom:6,titleAlign:"left",bodyColor:"#fff",bodySpacing:2,bodyFont:{},bodyAlign:"left",footerColor:"#fff",footerSpacing:2,footerMarginTop:6,footerFont:{weight:"bold"},footerAlign:"left",padding:6,caretPadding:2,caretSize:5,cornerRadius:6,boxHeight:(s,t)=>t.bodyFont.size,boxWidth:(s,t)=>t.bodyFont.size,multiKeyBackground:"#fff",displayColors:!0,boxPadding:0,borderColor:"rgba(0,0,0,0)",borderWidth:0,animation:{duration:400,easing:"easeOutQuart"},animations:{numbers:{type:"number",properties:["x","y","width","height","caretX","caretY"]},opacity:{easing:"linear",duration:200}},callbacks:ko},defaultRoutes:{bodyFont:"font",footerFont:"font",titleFont:"font"},descriptors:{_scriptable:s=>s!=="filter"&&s!=="itemSort"&&s!=="external",_indexable:!1,callbacks:{_scriptable:!1,_indexable:!1},animation:{_fallback:!1},animations:{_fallback:"animation"}},additionalOptionScopes:["interaction"]},fd=Object.freeze({__proto__:null,Colors:Cc,Decimation:Ac,Filler:Gc,Legend:ed,SubTitle:nd,Title:id,Tooltip:ud});const pd=(s,t,e,i)=>(typeof t=="string"?(e=s.push(t)-1,i.unshift({index:e,label:t})):isNaN(t)&&(e=null),e);function gd(s,t,e,i){const n=s.indexOf(t);if(n===-1)return pd(s,t,e,i);const o=s.lastIndexOf(t);return n!==o?e:n}const bd=(s,t)=>s===null?null:Y(Math.round(s),0,t);function gn(s){const t=this.getLabels();return s>=0&&s<t.length?t[s]:s}class Rs extends Vt{constructor(t){super(t),this._startValue=void 0,this._valueRange=0,this._addedLabels=[]}init(t){const e=this._addedLabels;if(e.length){const i=this.getLabels();for(const{index:n,label:o}of e)i[n]===o&&i.splice(n,1);this._addedLabels=[]}super.init(t)}parse(t,e){if(P(t))return null;const i=this.getLabels();return e=isFinite(e)&&i[e]===t?e:gd(i,t,T(e,t),this._addedLabels),bd(e,i.length-1)}determineDataLimits(){const{minDefined:t,maxDefined:e}=this.getUserBounds();let{min:i,max:n}=this.getMinMax(!0);this.options.bounds==="ticks"&&(t||(i=0),e||(n=this.getLabels().length-1)),this.min=i,this.max=n}buildTicks(){const t=this.min,e=this.max,i=this.options.offset,n=[];let o=this.getLabels();o=t===0&&e===o.length-1?o:o.slice(t,e+1),this._valueRange=Math.max(o.length-(i?0:1),1),this._startValue=this.min-(i?.5:0);for(let a=t;a<=e;a++)n.push({value:a});return n}getLabelForValue(t){return gn.call(this,t)}configure(){super.configure(),this.isHorizontal()||(this._reversePixels=!this._reversePixels)}getPixelForValue(t){return typeof t!="number"&&(t=this.parse(t)),t===null?NaN:this.getPixelForDecimal((t-this._startValue)/this._valueRange)}getPixelForTick(t){const e=this.ticks;return t<0||t>e.length-1?null:this.getPixelForValue(e[t].value)}getValueForPixel(t){return Math.round(this._startValue+this.getDecimalForPixel(t)*this._valueRange)}getBasePixel(){return this.bottom}}x(Rs,"id","category"),x(Rs,"defaults",{ticks:{callback:gn}});function md(s,t){const e=[],{bounds:n,step:o,min:a,max:r,precision:l,count:c,maxTicks:d,maxDigits:h,includeBounds:u}=s,f=o||1,p=d-1,{min:g,max:b}=t,m=!P(a),v=!P(r),w=!P(c),k=(b-g)/(h+1);let y=ci((b-g)/p/f)*f,_,S,C,E;if(y<1e-14&&!m&&!v)return[{value:g},{value:b}];E=Math.ceil(b/y)-Math.floor(g/y),E>p&&(y=ci(E*y/p/f)*f),P(l)||(_=Math.pow(10,l),y=Math.ceil(y*_)/_),n==="ticks"?(S=Math.floor(g/y)*y,C=Math.ceil(b/y)*y):(S=g,C=b),m&&v&&o&&ca((r-a)/o,y/1e3)?(E=Math.round(Math.min((r-a)/y,d)),y=(r-a)/E,S=a,C=r):w?(S=m?a:S,C=v?r:C,E=c-1,y=(C-S)/E):(E=(C-S)/y,he(E,Math.round(E),y/1e3)?E=Math.round(E):E=Math.ceil(E));const A=Math.max(di(y),di(S));_=Math.pow(10,P(l)?A:l),S=Math.round(S*_)/_,C=Math.round(C*_)/_;let L=0;for(m&&(u&&S!==a?(e.push({value:a}),S<a&&L++,he(Math.round((S+L*y)*_)/_,a,bn(a,k,s))&&L++):S<a&&L++);L<E;++L){const I=Math.round((S+L*y)*_)/_;if(v&&I>r)break;e.push({value:I})}return v&&u&&C!==r?e.length&&he(e[e.length-1].value,r,bn(r,k,s))?e[e.length-1].value=r:e.push({value:r}):(!v||C===r)&&e.push({value:C}),e}function bn(s,t,{horizontal:e,minRotation:i}){const n=rt(i),o=(e?Math.sin(n):Math.cos(n))||.001,a=.75*t*(""+s).length;return Math.min(t/o,a)}class es extends Vt{constructor(t){super(t),this.start=void 0,this.end=void 0,this._startValue=void 0,this._endValue=void 0,this._valueRange=0}parse(t,e){return P(t)||(typeof t=="number"||t instanceof Number)&&!isFinite(+t)?null:+t}handleTickRangeOptions(){const{beginAtZero:t}=this.options,{minDefined:e,maxDefined:i}=this.getUserBounds();let{min:n,max:o}=this;const a=l=>n=e?n:l,r=l=>o=i?o:l;if(t){const l=ut(n),c=ut(o);l<0&&c<0?r(0):l>0&&c>0&&a(0)}if(n===o){let l=o===0?1:Math.abs(o*.05);r(o+l),t||a(n-l)}this.min=n,this.max=o}getTickLimit(){const t=this.options.ticks;let{maxTicksLimit:e,stepSize:i}=t,n;return i?(n=Math.ceil(this.max/i)-Math.floor(this.min/i)+1,n>1e3&&(console.warn(`scales.${this.id}.ticks.stepSize: ${i} would result generating up to ${n} ticks. Limiting to 1000.`),n=1e3)):(n=this.computeTickLimit(),e=e||11),e&&(n=Math.min(e,n)),n}computeTickLimit(){return Number.POSITIVE_INFINITY}buildTicks(){const t=this.options,e=t.ticks;let i=this.getTickLimit();i=Math.max(2,i);const n={maxTicks:i,bounds:t.bounds,min:t.min,max:t.max,precision:e.precision,step:e.stepSize,count:e.count,maxDigits:this._maxDigits(),horizontal:this.isHorizontal(),minRotation:e.minRotation||0,includeBounds:e.includeBounds!==!1},o=this._range||this,a=md(n,o);return t.bounds==="ticks"&&Pn(a,this,"value"),t.reverse?(a.reverse(),this.start=this.max,this.end=this.min):(this.start=this.min,this.end=this.max),a}configure(){const t=this.ticks;let e=this.min,i=this.max;if(super.configure(),this.options.offset&&t.length){const n=(i-e)/Math.max(t.length-1,1)/2;e-=n,i+=n}this._startValue=e,this._endValue=i,this._valueRange=i-e}getLabelForValue(t){return Se(t,this.chart.options.locale,this.options.ticks.format)}}class $s extends es{determineDataLimits(){const{min:t,max:e}=this.getMinMax(!0);this.min=H(t)?t:0,this.max=H(e)?e:1,this.handleTickRangeOptions()}computeTickLimit(){const t=this.isHorizontal(),e=t?this.width:this.height,i=rt(this.options.ticks.minRotation),n=(t?Math.sin(i):Math.cos(i))||.001,o=this._resolveTickFontOptions(0);return Math.ceil(e/Math.min(40,o.lineHeight/n))}getPixelForValue(t){return t===null?NaN:this.getPixelForDecimal((t-this._startValue)/this._valueRange)}getValueForPixel(t){return this._startValue+this.getDecimalForPixel(t)*this._valueRange}}x($s,"id","linear"),x($s,"defaults",{ticks:{callback:ss.formatters.numeric}});const we=s=>Math.floor(wt(s)),It=(s,t)=>Math.pow(10,we(s)+t);function mn(s){return s/Math.pow(10,we(s))===1}function xn(s,t,e){const i=Math.pow(10,e),n=Math.floor(s/i);return Math.ceil(t/i)-n}function xd(s,t){const e=t-s;let i=we(e);for(;xn(s,t,i)>10;)i++;for(;xn(s,t,i)<10;)i--;return Math.min(i,we(s))}function vd(s,{min:t,max:e}){t=nt(s.min,t);const i=[],n=we(t);let o=xd(t,e),a=o<0?Math.pow(10,Math.abs(o)):1;const r=Math.pow(10,o),l=n>o?Math.pow(10,n):0,c=Math.round((t-l)*a)/a,d=Math.floor((t-l)/r/10)*r*10;let h=Math.floor((c-d)/Math.pow(10,o)),u=nt(s.min,Math.round((l+d+h*Math.pow(10,o))*a)/a);for(;u<e;)i.push({value:u,major:mn(u),significand:h}),h>=10?h=h<15?15:20:h++,h>=20&&(o++,h=2,a=o>=0?1:a),u=Math.round((l+d+h*Math.pow(10,o))*a)/a;const f=nt(s.max,u);return i.push({value:f,major:mn(f),significand:h}),i}class Fs extends Vt{constructor(t){super(t),this.start=void 0,this.end=void 0,this._startValue=void 0,this._valueRange=0}parse(t,e){const i=es.prototype.parse.apply(this,[t,e]);if(i===0){this._zero=!0;return}return H(i)&&i>0?i:null}determineDataLimits(){const{min:t,max:e}=this.getMinMax(!0);this.min=H(t)?Math.max(0,t):null,this.max=H(e)?Math.max(0,e):null,this.options.beginAtZero&&(this._zero=!0),this._zero&&this.min!==this._suggestedMin&&!H(this._userMin)&&(this.min=t===It(this.min,0)?It(this.min,-1):It(this.min,0)),this.handleTickRangeOptions()}handleTickRangeOptions(){const{minDefined:t,maxDefined:e}=this.getUserBounds();let i=this.min,n=this.max;const o=r=>i=t?i:r,a=r=>n=e?n:r;i===n&&(i<=0?(o(1),a(10)):(o(It(i,-1)),a(It(n,1)))),i<=0&&o(It(n,-1)),n<=0&&a(It(i,1)),this.min=i,this.max=n}buildTicks(){const t=this.options,e={min:this._userMin,max:this._userMax},i=vd(e,this);return t.bounds==="ticks"&&Pn(i,this,"value"),t.reverse?(i.reverse(),this.start=this.max,this.end=this.min):(this.start=this.min,this.end=this.max),i}getLabelForValue(t){return t===void 0?"0":Se(t,this.chart.options.locale,this.options.ticks.format)}configure(){const t=this.min;super.configure(),this._startValue=wt(t),this._valueRange=wt(this.max)-wt(t)}getPixelForValue(t){return(t===void 0||t===0)&&(t=this.min),t===null||isNaN(t)?NaN:this.getPixelForDecimal(t===this.min?0:(wt(t)-this._startValue)/this._valueRange)}getValueForPixel(t){const e=this.getDecimalForPixel(t);return Math.pow(10,this._startValue+e*this._valueRange)}}x(Fs,"id","logarithmic"),x(Fs,"defaults",{ticks:{callback:ss.formatters.logarithmic,major:{enabled:!0}}});function Ns(s){const t=s.ticks;if(t.display&&s.display){const e=Q(t.backdropPadding);return T(t.font&&t.font.size,V.font.size)+e.height}return 0}function yd(s,t,e){return e=j(e)?e:[e],{w:Ma(s,t.string,e),h:e.length*t.lineHeight}}function vn(s,t,e,i,n){return s===i||s===n?{start:t-e/2,end:t+e/2}:s<i||s>n?{start:t-e,end:t}:{start:t,end:t+e}}function wd(s){const t={l:s.left+s._padding.left,r:s.right-s._padding.right,t:s.top+s._padding.top,b:s.bottom-s._padding.bottom},e=Object.assign({},t),i=[],n=[],o=s._pointLabels.length,a=s.options.pointLabels,r=a.centerPointLabels?R/o:0;for(let l=0;l<o;l++){const c=a.setContext(s.getPointLabelContext(l));n[l]=c.padding;const d=s.getPointPosition(l,s.drawingArea+n[l],r),h=U(c.font),u=yd(s.ctx,h,s._pointLabels[l]);i[l]=u;const f=J(s.getIndexAngle(l)+r),p=Math.round(qs(f)),g=vn(p,d.x,u.w,0,180),b=vn(p,d.y,u.h,90,270);kd(e,t,f,g,b)}s.setCenterPoint(t.l-e.l,e.r-t.r,t.t-e.t,e.b-t.b),s._pointLabelItems=Cd(s,i,n)}function kd(s,t,e,i,n){const o=Math.abs(Math.sin(e)),a=Math.abs(Math.cos(e));let r=0,l=0;i.start<t.l?(r=(t.l-i.start)/o,s.l=Math.min(s.l,t.l-r)):i.end>t.r&&(r=(i.end-t.r)/o,s.r=Math.max(s.r,t.r+r)),n.start<t.t?(l=(t.t-n.start)/a,s.t=Math.min(s.t,t.t-l)):n.end>t.b&&(l=(n.end-t.b)/a,s.b=Math.max(s.b,t.b+l))}function _d(s,t,e){const i=s.drawingArea,{extra:n,additionalAngle:o,padding:a,size:r}=e,l=s.getPointPosition(t,i+n+a,o),c=Math.round(qs(J(l.angle+W))),d=Td(l.y,r.h,c),h=Md(c),u=Ed(l.x,r.w,h);return{visible:!0,x:l.x,y:d,textAlign:h,left:u,top:d,right:u+r.w,bottom:d+r.h}}function Sd(s,t){if(!t)return!0;const{left:e,top:i,right:n,bottom:o}=s;return!(vt({x:e,y:i},t)||vt({x:e,y:o},t)||vt({x:n,y:i},t)||vt({x:n,y:o},t))}function Cd(s,t,e){const i=[],n=s._pointLabels.length,o=s.options,{centerPointLabels:a,display:r}=o.pointLabels,l={extra:Ns(o)/2,additionalAngle:a?R/n:0};let c;for(let d=0;d<n;d++){l.padding=e[d],l.size=t[d];const h=_d(s,d,l);i.push(h),r==="auto"&&(h.visible=Sd(h,c),h.visible&&(c=h))}return i}function Md(s){return s===0||s===180?"center":s<180?"left":"right"}function Ed(s,t,e){return e==="right"?s-=t:e==="center"&&(s-=t/2),s}function Td(s,t,e){return e===90||e===270?s-=t/2:(e>270||e<90)&&(s-=t),s}function Ad(s,t,e){const{left:i,top:n,right:o,bottom:a}=e,{backdropColor:r}=t;if(!P(r)){const l=Nt(t.borderRadius),c=Q(t.backdropPadding);s.fillStyle=r;const d=i-c.left,h=n-c.top,u=o-i+c.width,f=a-n+c.height;Object.values(l).some(p=>p!==0)?(s.beginPath(),ve(s,{x:d,y:h,w:u,h:f,radius:l}),s.fill()):s.fillRect(d,h,u,f)}}function Ld(s,t){const{ctx:e,options:{pointLabels:i}}=s;for(let n=t-1;n>=0;n--){const o=s._pointLabelItems[n];if(!o.visible)continue;const a=i.setContext(s.getPointLabelContext(n));Ad(e,a,o);const r=U(a.font),{x:l,y:c,textAlign:d}=o;jt(e,s._pointLabels[n],l,c+r.lineHeight/2,r,{color:a.color,textAlign:d,textBaseline:"middle"})}}function _o(s,t,e,i){const{ctx:n}=s;if(e)n.arc(s.xCenter,s.yCenter,t,0,B);else{let o=s.getPointPosition(0,t);n.moveTo(o.x,o.y);for(let a=1;a<i;a++)o=s.getPointPosition(a,t),n.lineTo(o.x,o.y)}}function Pd(s,t,e,i,n){const o=s.ctx,a=t.circular,{color:r,lineWidth:l}=t;!a&&!i||!r||!l||e<0||(o.save(),o.strokeStyle=r,o.lineWidth=l,o.setLineDash(n.dash||[]),o.lineDashOffset=n.dashOffset,o.beginPath(),_o(s,e,a,i),o.closePath(),o.stroke(),o.restore())}function Dd(s,t,e){return Tt(s,{label:e,index:t,type:"pointLabel"})}class ce extends es{constructor(t){super(t),this.xCenter=void 0,this.yCenter=void 0,this.drawingArea=void 0,this._pointLabels=[],this._pointLabelItems=[]}setDimensions(){const t=this._padding=Q(Ns(this.options)/2),e=this.width=this.maxWidth-t.width,i=this.height=this.maxHeight-t.height;this.xCenter=Math.floor(this.left+e/2+t.left),this.yCenter=Math.floor(this.top+i/2+t.top),this.drawingArea=Math.floor(Math.min(e,i)/2)}determineDataLimits(){const{min:t,max:e}=this.getMinMax(!1);this.min=H(t)&&!isNaN(t)?t:0,this.max=H(e)&&!isNaN(e)?e:0,this.handleTickRangeOptions()}computeTickLimit(){return Math.ceil(this.drawingArea/Ns(this.options))}generateTickLabels(t){es.prototype.generateTickLabels.call(this,t),this._pointLabels=this.getLabels().map((e,i)=>{const n=N(this.options.pointLabels.callback,[e,i],this);return n||n===0?n:""}).filter((e,i)=>this.chart.getDataVisibility(i))}fit(){const t=this.options;t.display&&t.pointLabels.display?wd(this):this.setCenterPoint(0,0,0,0)}setCenterPoint(t,e,i,n){this.xCenter+=Math.floor((t-e)/2),this.yCenter+=Math.floor((i-n)/2),this.drawingArea-=Math.min(this.drawingArea/2,Math.max(t,e,i,n))}getIndexAngle(t){const e=B/(this._pointLabels.length||1),i=this.options.startAngle||0;return J(t*e+rt(i))}getDistanceFromCenterForValue(t){if(P(t))return NaN;const e=this.drawingArea/(this.max-this.min);return this.options.reverse?(this.max-t)*e:(t-this.min)*e}getValueForDistanceFromCenter(t){if(P(t))return NaN;const e=t/(this.drawingArea/(this.max-this.min));return this.options.reverse?this.max-e:this.min+e}getPointLabelContext(t){const e=this._pointLabels||[];if(t>=0&&t<e.length){const i=e[t];return Dd(this.getContext(),t,i)}}getPointPosition(t,e,i=0){const n=this.getIndexAngle(t)-W+i;return{x:Math.cos(n)*e+this.xCenter,y:Math.sin(n)*e+this.yCenter,angle:n}}getPointPositionForValue(t,e){return this.getPointPosition(t,this.getDistanceFromCenterForValue(e))}getBasePosition(t){return this.getPointPositionForValue(t||0,this.getBaseValue())}getPointLabelPosition(t){const{left:e,top:i,right:n,bottom:o}=this._pointLabelItems[t];return{left:e,top:i,right:n,bottom:o}}drawBackground(){const{backgroundColor:t,grid:{circular:e}}=this.options;if(t){const i=this.ctx;i.save(),i.beginPath(),_o(this,this.getDistanceFromCenterForValue(this._endValue),e,this._pointLabels.length),i.closePath(),i.fillStyle=t,i.fill(),i.restore()}}drawGrid(){const t=this.ctx,e=this.options,{angleLines:i,grid:n,border:o}=e,a=this._pointLabels.length;let r,l,c;if(e.pointLabels.display&&Ld(this,a),n.display&&this.ticks.forEach((d,h)=>{if(h!==0||h===0&&this.min<0){l=this.getDistanceFromCenterForValue(d.value);const u=this.getContext(h),f=n.setContext(u),p=o.setContext(u);Pd(this,f,l,a,p)}}),i.display){for(t.save(),r=a-1;r>=0;r--){const d=i.setContext(this.getPointLabelContext(r)),{color:h,lineWidth:u}=d;!u||!h||(t.lineWidth=u,t.strokeStyle=h,t.setLineDash(d.borderDash),t.lineDashOffset=d.borderDashOffset,l=this.getDistanceFromCenterForValue(e.reverse?this.min:this.max),c=this.getPointPosition(r,l),t.beginPath(),t.moveTo(this.xCenter,this.yCenter),t.lineTo(c.x,c.y),t.stroke())}t.restore()}}drawBorder(){}drawLabels(){const t=this.ctx,e=this.options,i=e.ticks;if(!i.display)return;const n=this.getIndexAngle(0);let o,a;t.save(),t.translate(this.xCenter,this.yCenter),t.rotate(n),t.textAlign="center",t.textBaseline="middle",this.ticks.forEach((r,l)=>{if(l===0&&this.min>=0&&!e.reverse)return;const c=i.setContext(this.getContext(l)),d=U(c.font);if(o=this.getDistanceFromCenterForValue(this.ticks[l].value),c.showLabelBackdrop){t.font=d.string,a=t.measureText(r.label).width,t.fillStyle=c.backdropColor;const h=Q(c.backdropPadding);t.fillRect(-a/2-h.left,-o-d.size/2-h.top,a+h.width,d.size+h.height)}jt(t,r.label,0,-o,d,{color:c.color,strokeColor:c.textStrokeColor,strokeWidth:c.textStrokeWidth})}),t.restore()}drawTitle(){}}x(ce,"id","radialLinear"),x(ce,"defaults",{display:!0,animate:!0,position:"chartArea",angleLines:{display:!0,lineWidth:1,borderDash:[],borderDashOffset:0},grid:{circular:!1},startAngle:0,ticks:{showLabelBackdrop:!0,callback:ss.formatters.numeric},pointLabels:{backdropColor:void 0,backdropPadding:2,display:!0,font:{size:10},callback(t){return t},padding:5,centerPointLabels:!1}}),x(ce,"defaultRoutes",{"angleLines.color":"borderColor","pointLabels.color":"color","ticks.color":"color"}),x(ce,"descriptors",{angleLines:{_fallback:"grid"}});const ls={millisecond:{common:!0,size:1,steps:1e3},second:{common:!0,size:1e3,steps:60},minute:{common:!0,size:6e4,steps:60},hour:{common:!0,size:36e5,steps:24},day:{common:!0,size:864e5,steps:30},week:{common:!1,size:6048e5,steps:4},month:{common:!0,size:2628e6,steps:12},quarter:{common:!1,size:7884e6,steps:4},year:{common:!0,size:3154e7}},st=Object.keys(ls);function yn(s,t){return s-t}function wn(s,t){if(P(t))return null;const e=s._adapter,{parser:i,round:n,isoWeekday:o}=s._parseOpts;let a=t;return typeof i=="function"&&(a=i(a)),H(a)||(a=typeof i=="string"?e.parse(a,i):e.parse(a)),a===null?null:(n&&(a=n==="week"&&(Xt(o)||o===!0)?e.startOf(a,"isoWeek",o):e.startOf(a,n)),+a)}function kn(s,t,e,i){const n=st.length;for(let o=st.indexOf(s);o<n-1;++o){const a=ls[st[o]],r=a.steps?a.steps:Number.MAX_SAFE_INTEGER;if(a.common&&Math.ceil((e-t)/(r*a.size))<=i)return st[o]}return st[n-1]}function Od(s,t,e,i,n){for(let o=st.length-1;o>=st.indexOf(e);o--){const a=st[o];if(ls[a].common&&s._adapter.diff(n,i,a)>=t-1)return a}return st[e?st.indexOf(e):0]}function Id(s){for(let t=st.indexOf(s)+1,e=st.length;t<e;++t)if(ls[st[t]].common)return st[t]}function _n(s,t,e){if(!e)s[t]=!0;else if(e.length){const{lo:i,hi:n}=Ws(e,t),o=e[i]>=t?e[i]:e[n];s[o]=!0}}function Rd(s,t,e,i){const n=s._adapter,o=+n.startOf(t[0].value,i),a=t[t.length-1].value;let r,l;for(r=o;r<=a;r=+n.add(r,1,i))l=e[r],l>=0&&(t[l].major=!0);return t}function Sn(s,t,e){const i=[],n={},o=t.length;let a,r;for(a=0;a<o;++a)r=t[a],n[r]=a,i.push({value:r,major:!1});return o===0||!e?i:Rd(s,i,n,e)}class ke extends Vt{constructor(t){super(t),this._cache={data:[],labels:[],all:[]},this._unit="day",this._majorUnit=void 0,this._offsets={},this._normalized=!1,this._parseOpts=void 0}init(t,e={}){const i=t.time||(t.time={}),n=this._adapter=new Hr._date(t.adapters.date);n.init(e),de(i.displayFormats,n.formats()),this._parseOpts={parser:i.parser,round:i.round,isoWeekday:i.isoWeekday},super.init(t),this._normalized=e.normalized}parse(t,e){return t===void 0?null:wn(this,t)}beforeLayout(){super.beforeLayout(),this._cache={data:[],labels:[],all:[]}}determineDataLimits(){const t=this.options,e=this._adapter,i=t.time.unit||"day";let{min:n,max:o,minDefined:a,maxDefined:r}=this.getUserBounds();function l(c){!a&&!isNaN(c.min)&&(n=Math.min(n,c.min)),!r&&!isNaN(c.max)&&(o=Math.max(o,c.max))}(!a||!r)&&(l(this._getLabelBounds()),(t.bounds!=="ticks"||t.ticks.source!=="labels")&&l(this.getMinMax(!1))),n=H(n)&&!isNaN(n)?n:+e.startOf(Date.now(),i),o=H(o)&&!isNaN(o)?o:+e.endOf(Date.now(),i)+1,this.min=Math.min(n,o-1),this.max=Math.max(n+1,o)}_getLabelBounds(){const t=this.getLabelTimestamps();let e=Number.POSITIVE_INFINITY,i=Number.NEGATIVE_INFINITY;return t.length&&(e=t[0],i=t[t.length-1]),{min:e,max:i}}buildTicks(){const t=this.options,e=t.time,i=t.ticks,n=i.source==="labels"?this.getLabelTimestamps():this._generate();t.bounds==="ticks"&&n.length&&(this.min=this._userMin||n[0],this.max=this._userMax||n[n.length-1]);const o=this.min,a=this.max,r=fa(n,o,a);return this._unit=e.unit||(i.autoSkip?kn(e.minUnit,this.min,this.max,this._getLabelCapacity(o)):Od(this,r.length,e.minUnit,this.min,this.max)),this._majorUnit=!i.major.enabled||this._unit==="year"?void 0:Id(this._unit),this.initOffsets(n),t.reverse&&r.reverse(),Sn(this,r,this._majorUnit)}afterAutoSkip(){this.options.offsetAfterAutoskip&&this.initOffsets(this.ticks.map(t=>+t.value))}initOffsets(t=[]){let e=0,i=0,n,o;this.options.offset&&t.length&&(n=this.getDecimalForValue(t[0]),t.length===1?e=1-n:e=(this.getDecimalForValue(t[1])-n)/2,o=this.getDecimalForValue(t[t.length-1]),t.length===1?i=o:i=(o-this.getDecimalForValue(t[t.length-2]))/2);const a=t.length<3?.5:.25;e=Y(e,0,a),i=Y(i,0,a),this._offsets={start:e,end:i,factor:1/(e+1+i)}}_generate(){const t=this._adapter,e=this.min,i=this.max,n=this.options,o=n.time,a=o.unit||kn(o.minUnit,e,i,this._getLabelCapacity(e)),r=T(n.ticks.stepSize,1),l=a==="week"?o.isoWeekday:!1,c=Xt(l)||l===!0,d={};let h=e,u,f;if(c&&(h=+t.startOf(h,"isoWeek",l)),h=+t.startOf(h,c?"day":a),t.diff(i,e,a)>1e5*r)throw new Error(e+" and "+i+" are too far apart with stepSize of "+r+" "+a);const p=n.ticks.source==="data"&&this.getDataTimestamps();for(u=h,f=0;u<i;u=+t.add(u,r,a),f++)_n(d,u,p);return(u===i||n.bounds==="ticks"||f===1)&&_n(d,u,p),Object.keys(d).sort(yn).map(g=>+g)}getLabelForValue(t){const e=this._adapter,i=this.options.time;return i.tooltipFormat?e.format(t,i.tooltipFormat):e.format(t,i.displayFormats.datetime)}format(t,e){const n=this.options.time.displayFormats,o=this._unit,a=e||n[o];return this._adapter.format(t,a)}_tickFormatFunction(t,e,i,n){const o=this.options,a=o.ticks.callback;if(a)return N(a,[t,e,i],this);const r=o.time.displayFormats,l=this._unit,c=this._majorUnit,d=l&&r[l],h=c&&r[c],u=i[e],f=c&&h&&u&&u.major;return this._adapter.format(t,n||(f?h:d))}generateTickLabels(t){let e,i,n;for(e=0,i=t.length;e<i;++e)n=t[e],n.label=this._tickFormatFunction(n.value,e,t)}getDecimalForValue(t){return t===null?NaN:(t-this.min)/(this.max-this.min)}getPixelForValue(t){const e=this._offsets,i=this.getDecimalForValue(t);return this.getPixelForDecimal((e.start+i)*e.factor)}getValueForPixel(t){const e=this._offsets,i=this.getDecimalForPixel(t)/e.factor-e.end;return this.min+i*(this.max-this.min)}_getLabelSize(t){const e=this.options.ticks,i=this.ctx.measureText(t).width,n=rt(this.isHorizontal()?e.maxRotation:e.minRotation),o=Math.cos(n),a=Math.sin(n),r=this._resolveTickFontOptions(0).size;return{w:i*o+r*a,h:i*a+r*o}}_getLabelCapacity(t){const e=this.options.time,i=e.displayFormats,n=i[e.unit]||i.millisecond,o=this._tickFormatFunction(t,0,Sn(this,[t],this._majorUnit),n),a=this._getLabelSize(o),r=Math.floor(this.isHorizontal()?this.width/a.w:this.height/a.h)-1;return r>0?r:1}getDataTimestamps(){let t=this._cache.data||[],e,i;if(t.length)return t;const n=this.getMatchingVisibleMetas();if(this._normalized&&n.length)return this._cache.data=n[0].controller.getAllParsedValues(this);for(e=0,i=n.length;e<i;++e)t=t.concat(n[e].controller.getAllParsedValues(this));return this._cache.data=this.normalize(t)}getLabelTimestamps(){const t=this._cache.labels||[];let e,i;if(t.length)return t;const n=this.getLabels();for(e=0,i=n.length;e<i;++e)t.push(wn(this,n[e]));return this._cache.labels=this._normalized?t:this.normalize(t)}normalize(t){return In(t.sort(yn))}}x(ke,"id","time"),x(ke,"defaults",{bounds:"data",adapters:{},time:{parser:!1,unit:!1,round:!1,isoWeekday:!1,minUnit:"millisecond",displayFormats:{}},ticks:{source:"auto",callback:!1,major:{enabled:!1}}});function Ne(s,t,e){let i=0,n=s.length-1,o,a,r,l;e?(t>=s[i].pos&&t<=s[n].pos&&({lo:i,hi:n}=xt(s,"pos",t)),{pos:o,time:r}=s[i],{pos:a,time:l}=s[n]):(t>=s[i].time&&t<=s[n].time&&({lo:i,hi:n}=xt(s,"time",t)),{time:o,pos:r}=s[i],{time:a,pos:l}=s[n]);const c=a-o;return c?r+(l-r)*(t-o)/c:r}class Bs extends ke{constructor(t){super(t),this._table=[],this._minPos=void 0,this._tableRange=void 0}initOffsets(){const t=this._getTimestampsForTable(),e=this._table=this.buildLookupTable(t);this._minPos=Ne(e,this.min),this._tableRange=Ne(e,this.max)-this._minPos,super.initOffsets(t)}buildLookupTable(t){const{min:e,max:i}=this,n=[],o=[];let a,r,l,c,d;for(a=0,r=t.length;a<r;++a)c=t[a],c>=e&&c<=i&&n.push(c);if(n.length<2)return[{time:e,pos:0},{time:i,pos:1}];for(a=0,r=n.length;a<r;++a)d=n[a+1],l=n[a-1],c=n[a],Math.round((d+l)/2)!==c&&o.push({time:c,pos:a/(r-1)});return o}_generate(){const t=this.min,e=this.max;let i=super.getDataTimestamps();return(!i.includes(t)||!i.length)&&i.splice(0,0,t),(!i.includes(e)||i.length===1)&&i.push(e),i.sort((n,o)=>n-o)}_getTimestampsForTable(){let t=this._cache.all||[];if(t.length)return t;const e=this.getDataTimestamps(),i=this.getLabelTimestamps();return e.length&&i.length?t=this.normalize(e.concat(i)):t=e.length?e:i,t=this._cache.all=t,t}getDecimalForValue(t){return(Ne(this._table,t)-this._minPos)/this._tableRange}getValueForPixel(t){const e=this._offsets,i=this.getDecimalForPixel(t)/e.factor-e.end;return Ne(this._table,i*this._tableRange+this._minPos,!0)}}x(Bs,"id","timeseries"),x(Bs,"defaults",ke.defaults);var $d=Object.freeze({__proto__:null,CategoryScale:Rs,LinearScale:$s,LogarithmicScale:Fs,RadialLinearScale:ce,TimeScale:ke,TimeSeriesScale:Bs});const Fd=[Vr,xc,fd,$d];et.register(...Fd);class Nd{constructor(t,e){x(this,"container");x(this,"currentPeriod","30d");x(this,"fechaDesde","");x(this,"fechaHasta","");x(this,"chartInstances",{});x(this,"onViewTicket");x(this,"onNavigateTicketsWithFilter");this.container=t,this.onViewTicket=e.onViewTicket,this.onNavigateTicketsWithFilter=e.onNavigateTicketsWithFilter}async render(){this.container.innerHTML=`
    ...
    `}async fetchAuxiliaryData(){try{if(this.clientsList.length===0||this.platformsList.length===0||this.agentsList.length===0){const[t,e,i]=await Promise.all([M.getClients(),M.getPlatforms(),M.getAgents()]);t.data&&(this.clientsList=t.data),e.data&&(this.platformsList=e.data),i.data&&(this.agentsList=i.data),this.updateFilterDropdownOptions()}}catch(t){console.error("Error fetching auxiliary data:",t)}}updateFilterDropdownOptions(){const t=this.container.querySelector("#filter-plataforma");t&&t.options.length<=1&&this.platformsList.forEach(n=>{const o=document.createElement("option");o.value=String(n.id),o.text=n.nombre,String(this.filters.plataforma_id)===String(n.id)&&(o.selected=!0),t.appendChild(o)});const e=this.container.querySelector("#filter-cliente");e&&e.options.length<=1&&this.clientsList.forEach(n=>{const o=document.createElement("option");o.value=String(n.id),o.text=n.nombre,String(this.filters.cliente_id)===String(n.id)&&(o.selected=!0),e.appendChild(o)});const i=this.container.querySelector("#filter-agente");i&&i.options.length<=1&&this.agentsList.forEach(n=>{const o=document.createElement("option");o.value=String(n.id),o.text=n.nombre,String(this.filters.agente_id)===String(n.id)&&(o.selected=!0),i.appendChild(o)})}async fetchTickets(){const t=this.container.querySelector("#tickets-table-body-container");t&&(t.innerHTML=`
      ...
      `);try{const e=await M.getTickets(this.filters);if(e.data){this.tickets=e.data,e.pagination&&(this.pagination=e.pagination),this.renderTable(),this.renderPaginationFooter();const i=this.container.querySelector("#ticket-total-badge");i&&(i.textContent=`${this.pagination.total} casos`);const n=this.container.querySelector("#export-excel-link"),o=this.container.querySelector("#export-csv-link");n&&(n.setAttribute("href","#"),n.onclick=a=>{a.preventDefault(),M.downloadExport("excel",this.filters).catch(r=>{alert(r.message||"No se pudo generar el archivo Excel.")})}),o&&(o.setAttribute("href","#"),o.onclick=a=>{a.preventDefault(),M.downloadExport("csv",this.filters).catch(r=>{alert(r.message||"No se pudo generar el archivo CSV.")})})}}catch(e){t&&(t.innerHTML=`
    ...
    `,i.querySelectorAll("[data-new-status]").forEach(o=>{o.addEventListener("click",async()=>{const a=o.getAttribute("data-new-status");if(a)try{await M.changeTicketStatus(t,a),O.success(`Caso #${t} actualizado a ${a}`),i.remove(),this.fetchTickets()}catch(r){O.error(r.message||"Error al cambiar estado.")}})}),(n=i.querySelector("#close-quick-status-btn"))==null||n.addEventListener("click",()=>{i.remove()}),e.appendChild(i)}}class zd{constructor(t,e){x(this,"container");x(this,"clients",[]);x(this,"search","");x(this,"estado","");x(this,"onFilterByClient");this.container=t,this.onFilterByClient=e}async render(){const t=M.hasRole("ADMIN");this.container.innerHTML=`
      <div class="space-y-5 animate-fade-in pb-12">
        <!-- Header -->
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200/80 shadow-card">
          <div>
    ...
    `,this.bindEvents(),await this.fetchClients()}bindEvents(){var n;const t=this.container.querySelector("#client-search-input");let e;t==null||t.addEventListener("input",()=>{clearTimeout(e),e=setTimeout(()=>{this.search=t.value,this.fetchClients()},300)});const i=this.container.querySelector("#client-status-filter");i==null||i.addEventListener("change",()=>{this.estado=i.value,this.fetchClients()}),(n=this.container.querySelector("#new-client-btn"))==null||n.addEventListener("click",()=>{this.openClientModal()})}async fetchClients(){const t=this.container.querySelector("#clients-grid");if(t)try{const e=await M.getClients(this.search,this.estado);e.data&&(this.clients=e.data,this.renderGrid())}catch(e){t.innerHTML=`<div class="col-span-full p-8 text-center text-rose-500 text-sm">Error al cargar clientes: ${e.message}</div>`}}renderGrid(){const t=this.container.querySelector("#clients-grid");if(!t)return;if(this.clients.length===0){t.innerHTML='<div class="col-span-full py-12 text-center text-slate-400 text-sm">No se encontraron clientes registrados.</div>';return}const e=M.hasRole("ADMIN");t.innerHTML=this.clients.map(i=>`
    ...
    `;const o=()=>n.remove();(r=n.querySelector("#close-c-modal"))==null||r.addEventListener("click",o),(l=n.querySelector("#cancel-c-modal"))==null||l.addEventListener("click",o);const a=n.querySelector("#client-form");a==null||a.addEventListener("submit",async c=>{c.preventDefault();const d=new FormData(a),h={nombre:String(d.get("nombre")),nit:String(d.get("nit")),contacto_principal:String(d.get("contacto_principal")),correo_contacto:String(d.get("correo_contacto")),telefono:String(d.get("telefono"))};try{i&&t?(await M.updateClient(t.id,h),O.success("Cliente actualizado correctamente.")):(await M.createClient(h),O.success("Cliente registrado correctamente.")),o(),this.fetchClients()}catch(u){O.error(u.message||"Error al guardar cliente.")}}),e.appendChild(n)}}class jd{constructor(t,e){x(this,"container");x(this,"platforms",[]);x(this,"search","");x(this,"onFilterByPlatform");this.container=t,this.onFilterByPlatform=e}async render(){const t=M.hasRole("ADMIN");this.container.innerHTML=`
      <div class="space-y-5 animate-fade-in pb-12">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200/80 shadow-card">
          <div>
    ...
    `,this.bindEvents(),await this.fetchPlatforms()}bindEvents(){var i;const t=this.container.querySelector("#plat-search-input");let e;t==null||t.addEventListener("input",()=>{clearTimeout(e),e=setTimeout(()=>{this.search=t.value,this.fetchPlatforms()},300)}),(i=this.container.querySelector("#new-plat-btn"))==null||i.addEventListener("click",()=>{this.openPlatformModal()})}async fetchPlatforms(){const t=this.container.querySelector("#platforms-grid");if(t)try{const e=await M.getPlatforms(this.search);e.data&&(this.platforms=e.data,this.renderGrid())}catch(e){t.innerHTML=`<div class="col-span-full p-8 text-center text-rose-500 text-sm">Error al cargar plataformas: ${e.message}</div>`}}renderGrid(){const t=this.container.querySelector("#platforms-grid");if(!t)return;if(this.platforms.length===0){t.innerHTML='<div class="col-span-full py-12 text-center text-slate-400 text-sm">No se encontraron plataformas registradas.</div>';return}const e=M.hasRole("ADMIN");t.innerHTML=this.platforms.map(i=>`
      <div class="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-card hover:shadow-card-hover transition-all flex flex-col justify-between group">
        <div>
          <div class="flex items-start justify-between gap-3">
            <div class="flex items-center gap-3">
    ...
    `).join(""),t.querySelectorAll("[data-view-plat-tickets]").forEach(i=>{i.addEventListener("click",()=>{const n=Number(i.getAttribute("data-view-plat-tickets"));n&&this.onFilterByPlatform(n)})}),t.querySelectorAll("[data-edit-plat]").forEach(i=>{i.addEventListener("click",()=>{const n=Number(i.getAttribute("data-edit-plat")),o=this.platforms.find(a=>a.id===n);o&&this.openPlatformModal(o)})}),t.querySelectorAll("[data-toggle-plat]").forEach(i=>{i.addEventListener("click",async()=>{const n=Number(i.getAttribute("data-toggle-plat"));if(n)try{const o=await M.togglePlatformStatus(n);O.success(o.message||"Estado actualizado."),this.fetchPlatforms()}catch(o){O.error(o.message||"Error al modificar estado.")}})})}openPlatformModal(t){var r,l;const e=document.getElementById("modal-container");if(!e)return;const i=!!t,n=document.createElement("div");n.className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-fade-in",n.innerHTML=`
      <div class="bg-white rounded-3xl max-w-md w-full shadow-modal border border-slate-100 overflow-hidden">
        <div class="px-6 py-4 bg-brand-dark text-white flex items-center justify-between">
    ...
    `;const o=()=>n.remove();(r=n.querySelector("#close-p-modal"))==null||r.addEventListener("click",o),(l=n.querySelector("#cancel-p-modal"))==null||l.addEventListener("click",o);const a=n.querySelector("#plat-form");a==null||a.addEventListener("submit",async c=>{c.preventDefault();const d=new FormData(a),h={nombre:String(d.get("nombre")),descripcion:String(d.get("descripcion")),color_badge:String(d.get("color_badge"))};try{i&&t?(await M.updatePlatform(t.id,h),O.success("Plataforma actualizada correctamente.")):(await M.createPlatform(h),O.success("Plataforma registrada correctamente.")),o(),this.fetchPlatforms()}catch(u){O.error(u.message||"Error al guardar plataforma.")}}),e.appendChild(n)}}class Vd{constructor(t,e){x(this,"container");x(this,"agents",[]);x(this,"pagination",{total:0,page:1,limit:25,totalPages:1});x(this,"searchQuery","");x(this,"estadoFilter","all");x(this,"onNavigateToTickets");this.container=t,this.onNavigateToTickets=e.onNavigateToTickets}async render(){this.container.innerHTML=`
      <div class="space-y-6 animate-fade-in pb-12">
    ...
    `,this.bindEvents(),await this.fetchAgents()}bindEvents(){const t=this.container.querySelector("#agent-search-input");let e;t==null||t.addEventListener("input",()=>{clearTimeout(e),e=setTimeout(()=>{this.searchQuery=t.value.trim(),this.fetchAgents()},300)});const i=this.container.querySelector("#agent-estado-filter");i==null||i.addEventListener("change",()=>{this.estadoFilter=i.value,this.fetchAgents()})}async fetchAgents(){try{const t=await M.getAgents(this.searchQuery||void 0,this.estadoFilter);t.data&&(this.agents=t.data,this.renderTable())}catch(t){const e=this.container.querySelector("#agents-table-container");e&&(e.innerHTML=`<div class="p-6 text-center text-rose-500 text-xs">Error al cargar agentes: ${t.message}</div>`)}}renderTable(){const t=this.container.querySelector("#agents-table-container");if(t){if(this.agents.length===0){t.innerHTML='<div class="p-8 text-center text-slate-400 text-xs">No se encontraron agentes.</div>';return}t.innerHTML=`
      <table class="w-full text-left border-collapse text-xs font-lato">
        ...
        <tbody class="divide-y divide-slate-100">
          ${this.agents.map(e=>`
            <tr class="hover:bg-slate-50 transition-colors cursor-pointer" data-agent-id="${e.id}">
              ...
              <td class="py-3 px-4 text-slate-700 font-semibold">${e.total_casos??"-"}</td>
              <td class="py-3 px-4"><span class="text-[11px] font-semibold ${e.estado==="ACTIVO"?"text-emerald-600":"text-slate-400"}">${e.estado}</span></td>
            </tr>
          `).join("")}
        </tbody>
      </table>
    `,t.querySelectorAll("[data-agent-id]").forEach(e=>{e.addEventListener("click",()=>{const i=Number(e.getAttribute("data-agent-id"));i&&this.onNavigateToTickets(i)})})}}}class Hd{constructor(t){x(this,"container");x(this,"filters",{prioridad:"",cliente_id:"",plataforma_id:"",turno:"",estado:"",fecha_desde:"",fecha_hasta:""});x(this,"clientsList",[]);x(this,"platformsList",[]);x(this,"agentsList",[]);this.container=t}async render(){this.container.innerHTML=`
      <div class="space-y-6 animate-fade-in pb-12">
        <!-- Header -->
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200/80 shadow-card">
          <div>
    ...
    `,await this.loadSelectOptions(),this.updateExportLinks(),this.bindEvents()}async loadSelectOptions(){try{const[t,e,i]=await Promise.all([M.getClients(),M.getPlatforms(),M.getAgents()]);t.data&&(this.clientsList=t.data),e.data&&(this.platformsList=e.data),i.data&&(this.agentsList=i.data);const n=this.container.querySelector("#report-client");this.clientsList.forEach(r=>{const l=document.createElement("option");l.value=String(r.id),l.text=r.nombre,n.appendChild(l)});const o=this.container.querySelector("#report-platform");this.platformsList.forEach(r=>{const l=document.createElement("option");l.value=String(r.id),l.text=r.nombre,o.appendChild(l)});const a=this.container.querySelector("#report-agent");this.agentsList.forEach(r=>{const l=document.createElement("option");l.value=String(r.id),l.text=r.nombre,a.appendChild(l)})}catch(t){console.error(t)}}updateExportLinks(){const t=this.container.querySelector("#btn-export-excel"),e=this.container.querySelector("#btn-export-csv");t&&t.setAttribute("href","#"),e&&e.setAttribute("href","#")}bindEvents(){var i,n,o;const t=()=>{var a,r,l,c,d,h,u,f;this.filters.cliente_id=(a=this.container.querySelector("#report-client"))==null?void 0:a.value,this.filters.plataforma_id=(r=this.container.querySelector("#report-platform"))==null?void 0:r.value,this.filters.estado=(l=this.container.querySelector("#report-status"))==null?void 0:l.value,this.filters.prioridad=(c=this.container.querySelector("#report-priority"))==null?void 0:c.value,this.filters.turno=(d=this.container.querySelector("#report-shift"))==null?void 0:d.value,this.filters.agente_id=(h=this.container.querySelector("#report-agent"))==null?void 0:h.value,this.filters.fecha_desde=(u=this.container.querySelector("#report-from"))==null?void 0:u.value,this.filters.fecha_hasta=(f=this.container.querySelector("#report-to"))==null?void 0:f.value,this.updateExportLinks()};this.container.querySelectorAll("select, input").forEach(a=>{a.addEventListener("change",t)});const e=async a=>{try{await M.downloadExport(a,this.filters)}catch(r){alert(r.message||"No se pudo generar el archivo.")}};(i=this.container.querySelector("#btn-export-excel"))==null||i.addEventListener("click",a=>{a.preventDefault(),e("excel")}),(n=this.container.querySelector("#btn-export-csv"))==null||n.addEventListener("click",a=>{a.preventDefault(),e("csv")}),(o=this.container.querySelector("#btn-print-report"))==null||o.addEventListener("click",()=>{window.print()})}}class qd{constructor(t){x(this,"container");x(this,"activeTab","users");x(this,"users",[]);x(this,"clients",[]);x(this,"platforms",[]);this.container=t}async render(){const t=M.hasRole("ADMIN");this.container.innerHTML=`
      <div class="space-y-6 animate-fade-in pb-12">
        <div class="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-card">
    ...
    `,this.bindGlobalEvents(),await this.fetchTabData()}getTabTitle(){switch(this.activeTab){case"users":return"Usuarios del Sistema";case"clients":return"Clientes / Empresas";case"platforms":return"Plataformas Tecnológicas"}}async fetchTabData(){try{if(this.activeTab==="users"){const t=await M.getUsers();this.users=t.data||[],this.renderUsersTable()}else if(this.activeTab==="clients"){const t=await M.getClients();this.clients=t.data||[],this.renderClientsTable()}else if(this.activeTab==="platforms"){const t=await M.getPlatforms();this.platforms=t.data||[],this.renderPlatformsTable()}}catch(t){console.error("SettingsView fetchTabData error",t);const e=this.container.querySelector("#entity-table-container");e&&(e.innerHTML=`<div class="p-6 text-center text-rose-500 text-xs">Error al cargar datos: ${t.message}</div>`)}}renderUsersTable(){const t=this.container.querySelector("#entity-table-container");t&&(t.innerHTML=this.buildTable([{key:"nombre",label:"Usuario"},{key:"email",label:"Correo"},{key:"rol",label:"Rol"},{key:"estado",label:"Estado"}],this.users,e=>`
      ...
      <td class="py-3 px-4"><span class="text-[11px] font-semibold ${e.estado==="ACTIVO"?"text-emerald-600":"text-slate-400"}">${e.estado}</span></td>
    `,"user"),this.bindTableActions(t,"user",M,"toggleUserStatus","deleteUser"))}renderClientsTable(){const t=this.container.querySelector("#entity-table-container");t&&(t.innerHTML=this.buildTable([{key:"nombre",label:"Cliente"},{key:"nit",label:"NIT"},{key:"contacto_principal",label:"Contacto"},{key:"estado",label:"Estado"}],this.clients,e=>`
      <td class="py-3 px-4 font-montserrat font-bold text-slate-800">${e.nombre}</td>
      <td class="py-3 px-4 text-slate-600 font-mono">${e.nit||"-"}</td>
      <td class="py-3 px-4 text-slate-600">${e.contacto_principal||"-"}</td>
      <td class="py-3 px-4"><span class="text-[11px] font-semibold ${e.estado==="ACTIVO"?"text-emerald-600":"text-slate-400"}">${e.estado}</span></td>
    `,"client"),this.bindTableActions(t,"client",M,"toggleClientStatus","deleteClient"))}renderPlatformsTable(){const t=this.container.querySelector("#entity-table-container");t&&(t.innerHTML=this.buildTable([{key:"nombre",label:"Plataforma"},{key:"descripcion",label:"Descripción"},{key:"total_casos",label:"Casos"},{key:"estado",label:"Estado"}],this.platforms,e=>`
      <td class="py-3 px-4 font-montserrat font-bold text-slate-800">${e.nombre}</td>
      <td class="py-3 px-4 text-slate-600">${e.descripcion||"-"}</td>
      <td class="py-3 px-4 text-slate-600">${e.total_casos||0}</td>
      <td class="py-3 px-4"><span class="text-[11px] font-semibold ${e.estado==="ACTIVO"?"text-emerald-600":"text-slate-400"}">${e.estado}</span></td>
    `,"platform"),this.bindTableActions(t,"platform",M,"togglePlatformStatus","deletePlatform"))}buildTable(t,e,i,n){return e.length===0?'<div class="p-6 text-center text-slate-400 text-xs">No hay registros.</div>':`
      <table class="w-full text-left border-collapse text-xs font-lato">
        <thead>
          <tr class="bg-slate-50 border-b border-slate-200/80 text-[11px] font-montserrat font-bold text-slate-500 uppercase tracking-wider">
    ...
    `}bindGlobalEvents(){var t;this.container.querySelectorAll(".settings-tab").forEach(e=>{e.addEventListener("click",()=>{this.activeTab=e.getAttribute("data-tab")||"users",this.render()})}),(t=this.container.querySelector("#new-entity-btn"))==null||t.addEventListener("click",()=>{this.openEntityModal()})}bindTableActions(t,e,i,n,o){t.querySelectorAll(`[data-toggle-${e}]`).forEach(a=>{a.addEventListener("click",async()=>{const r=Number(a.getAttribute(`data-toggle-${e}`));if(confirm("¿Cambiar estado?"))try{const l=await i[n](r);O.success(l.message||"Estado actualizado."),await this.fetchTabData()}catch(l){O.error(l.message||"Error al cambiar estado.")}})}),t.querySelectorAll(`[data-delete-${e}]`).forEach(a=>{a.addEventListener("click",async()=>{const r=Number(a.getAttribute(`data-delete-${e}`));if(confirm(`¿Eliminar ID ${r}?`))try{await i[o](r),O.success("Eliminado correctamente."),await this.fetchTabData()}catch(l){O.error(l.message||"Error al eliminar.")}})})}openEntityModal(){var r,l;const t=document.getElementById("modal-container");if(!t)return;const e=document.createElement("div");e.className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-fade-in";const i=this.getModalTitle(),n=this.getModalFormContent();e.innerHTML=`
      <div class="bg-white rounded-3xl max-w-md w-full shadow-modal border border-slate-100 overflow-hidden">
        <div class="px-6 py-4 bg-brand-dark text-white flex items-center justify-between">
    ...
    `;const o=()=>e.remove();(r=e.querySelector("#close-e-modal"))==null||r.addEventListener("click",o),(l=e.querySelector("#cancel-e-modal"))==null||l.addEventListener("click",o);const a=e.querySelector("#entity-form");a==null||a.addEventListener("submit",async c=>{c.preventDefault();const d=new FormData(a);try{await this.submitEntityForm(d),O.success("Guardado correctamente."),o(),await this.fetchTabData()}catch(h){O.error(h.message||"Error al guardar.")}}),t.appendChild(e)}getModalTitle(){switch(this.activeTab){case"users":return"Crear Usuario del Sistema";case"clients":return"Registrar Nuevo Cliente";case"platforms":return"Registrar Nueva Plataforma"}}getModalFormContent(){switch(this.activeTab){case"users":return`
        ...
        `}return""}async submitEntityForm(t){const e={};switch(t.forEach((i,n)=>{e[n]=i}),this.activeTab){case"users":await M.createUser({nombre:e.nombre,email:e.email,password:e.password,rol:e.rol});break;case"clients":await M.createClient({nombre:e.nombre,nit:e.nit,contacto_principal:e.contacto_principal,correo_contacto:e.correo_contacto,telefono:e.telefono});break;case"platforms":await M.createPlatform({nombre:e.nombre,descripcion:e.descripcion,color_badge:e.color_badge});break}}}class Cn{constructor(t){x(this,"ticket",null);x(this,"isEdit",!1);x(this,"clients",[]);x(this,"platforms",[]);x(this,"agents",[]);x(this,"onSuccess");this.ticket=t.ticket||null,this.isEdit=!!t.ticket,this.clients=t.clients.filter(e=>e.estado==="ACTIVO"),this.platforms=t.platforms.filter(e=>e.estado==="ACTIVO"),this.agents=t.agents||[],this.onSuccess=t.onSuccess}open(){var r,l,c,d,h,u,f,p,g;const t=document.getElementById("modal-container");if(!t)return;const e=document.createElement("div");e.className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-slate-900/60 backdrop-blur-xs overflow-y-auto animate-fade-in";const i=M.hasRole("ADMIN"),n=(r=this.ticket)!=null&&r.fecha_creacion?this.ticket.fecha_creacion.slice(0,16):new Date().toISOString().slice(0,16);e.innerHTML=`
      <div class="bg-white rounded-3xl max-w-3xl w-full shadow-modal border border-slate-100 overflow-hidden my-auto max-h-[90vh] flex flex-col">
        ...
        <div class="px-6 py-4 bg-brand-dark text-white flex items-center justify-between border-b border-white/10 flex-shrink-0">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h2 class="text-base font-montserrat font-bold">${this.isEdit?`Editar Caso #${(l=this.ticket)==null?void 0:l.id}`:"Registrar Nuevo Caso de Soporte"}</h2>
          ...
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div class="grid grid-cols-4 gap-1.5" id="prio-selector">
                  ${["MEDIO","ALTO","BAJO","CRITICO"].map(b=>{var v;const m=(((v=this.ticket)==null?void 0:v.prioridad)||"MEDIO")===b;return`
                      <button 
                        type="button" 
                        data-prio-val="${b}" 
                        class="prio-badge-btn py-2 px-1 text-center font-montserrat font-bold text-[10px] rounded-xl border transition-all ${m?"bg-brand-primary text-white border-brand-primary shadow-xs ring-2 ring-brand-primary/20":"bg-slate-50 text-slate-600 border-slate-200 hover:bg-slate-100"}"
                      >
                        ${b}
                      </button>
                    `}).join("")}
                </div>
                <input type="hidden" name="prioridad" id="form-prioridad" value="${((c=this.ticket)==null?void 0:c.prioridad)||"MEDIO"}" />
              </div>
              ...
              <div>
                ...
                <select name="plataforma_id" id="form-plataforma" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl font-lato focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary focus:bg-white focus:outline-none" required>
                  ...
                  ${this.platforms.map(b=>{var m;return`
                    <option value="${b.id}" ${((m=this.ticket)==null?void 0:m.plataforma_id)===b.id?"selected":""}>${b.nombre}</option>
                  `}).join("")}
                </select>
              </div>
              ...
              <div>
                ...
                <select name="cliente_id" id="form-cliente" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl font-lato focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary focus:bg-white focus:outline-none" required>
                  ...
                  ${this.clients.map(b=>{var m;return`
                    <option value="${b.id}" ${((m=this.ticket)==null?void 0:m.cliente_id)===b.id?"selected":""}>${b.nombre}</option>
                  `}).join("")}
                </select>
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  name="solicitante" 
                  id="form-solicitante" 
                  value="${((d=this.ticket)==null?void 0:d.solicitante)||""}" 
            ...
            <div>
              ...
              <input 
                ...
                name="asunto" 
                id="form-asunto" 
                value="${((h=this.ticket)==null?void 0:h.asunto)||""}" 
            ...
            <div>
              ...
              <textarea 
                ...
                required
              >${((u=this.ticket)==null?void 0:u.descripcion)||""}</textarea>
            </div>
          </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
               ...
               <div>
                 ...
                 <select name="turno" id="form-turno" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl font-lato focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary focus:bg-white focus:outline-none" required>
                   ${["NA","T1","T2","T4","TD","TN"].map(b=>{var m;return`
                     <option value="${b}" ${((m=this.ticket)==null?void 0:m.turno)===b?"selected":""}>${b}</option>
                   `}).join("")}
                 </select>
               </div>
               ...
               <div>
                 ...
                 <select name="agente_id" id="form-agente" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl font-lato focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary focus:bg-white focus:outline-none" required>
                   ...
                   ${this.agents.map(b=>{var m;return`
                     <option value="${b.id}" ${((m=this.ticket)==null?void 0:m.agente_id)===b.id?"selected":""}>${b.nombre}</option>
                   `}).join("")}
                 </select>
               </div>
              ...
              <div>
                ...
                <select name="estado" id="form-estado" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl font-lato focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary focus:bg-white focus:outline-none" required>
                  ${["ABIERTO","EN PROCESO","PENDIENTE","RESUELTO","CERRADO"].map(b=>{var m;return`
                    <option value="${b}" ${(((m=this.ticket)==null?void 0:m.estado)||"ABIERTO")===b?"selected":""}>${b}</option>
                  `}).join("")}
                </select>
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  name="servicenow" 
                  id="form-servicenow" 
                  value="${((f=this.ticket)==null?void 0:f.servicenow)||""}" 
              ...
              <!-- Fecha de Creación -->
              <div class="${i?"":"opacity-75"}">
                <label class="block font-montserrat font-semibold text-slate-700 mb-1.5">
                  Fecha Creación ${i?"":"(Automática)"}
                </label>
                <input 
                  type="datetime-local" 
                  name="fecha_creacion" 
    ...
    `,e.querySelectorAll(".prio-badge-btn").forEach(b=>{b.addEventListener("click",()=>{const m=b.getAttribute("data-prio-val");m&&(e.querySelector("#form-prioridad").value=m,e.querySelectorAll(".prio-badge-btn").forEach(v=>{v.className="prio-badge-btn py-2 px-1 text-center font-montserrat font-bold text-[10px] rounded-xl border transition-all bg-slate-50 text-slate-600 border-slate-200 hover:bg-slate-100"}),b.className="prio-badge-btn py-2 px-1 text-center font-montserrat font-bold text-[10px] rounded-xl border transition-all bg-brand-primary text-white border-brand-primary shadow-xs ring-2 ring-brand-primary/20")})});const o=()=>e.remove();(p=e.querySelector("#modal-close-btn"))==null||p.addEventListener("click",o),(g=e.querySelector("#modal-cancel-btn"))==null||g.addEventListener("click",o);const a=e.querySelector("#ticket-form");a==null||a.addEventListener("submit",async b=>{var v;b.preventDefault();const m=e.querySelector("#modal-submit-btn");m.disabled=!0,m.innerHTML="<span>Guardando...</span>";try{const w=new FormData(a),k={prioridad:w.get("prioridad"),plataforma_id:Number(w.get("plataforma_id")),cliente_id:Number(w.get("cliente_id")),solicitante:w.get("solicitante"),asunto:w.get("asunto"),descripcion:w.get("descripcion"),turno:w.get("turno"),agente_id:Number(w.get("agente_id")),estado:w.get("estado"),servicenow:w.get("servicenow")||null,fecha_creacion:w.get("fecha_creacion")?String(w.get("fecha_creacion")).replace("T"," ")+":00":void 0};if(this.isEdit&&this.ticket)await M.updateTicket(this.ticket.id,k),O.success(`Caso #${this.ticket.id} actualizado exitosamente.`);else{const y=await M.createTicket(k);O.success(`Caso #${(v=y.data)==null?void 0:v.id} creado exitosamente.`)}o(),this.onSuccess()}catch(w){O.error(w.message||"Error al guardar el caso."),m.disabled=!1,m.innerHTML=`<span>${this.isEdit?"Actualizar caso":"Guardar caso"}</span>`}}),t.appendChild(e)}}class Wd{constructor(t){x(this,"ticketId");x(this,"onEdit");x(this,"onDelete");x(this,"onStatusChanged");this.ticketId=t.ticketId,this.onEdit=t.onEdit,this.onDelete=t.onDelete,this.onStatusChanged=t.onStatusChanged}async open(){var n;const t=document.getElementById("drawer-container");if(!t)return;const e=document.createElement("div");e.className="fixed inset-0 z-50 overflow-hidden bg-slate-900/60 backdrop-blur-xs flex justify-end animate-fade-in",e.innerHTML=`
    ...
    `;const i=()=>e.remove();(n=e.querySelector("#drawer-close-btn"))==null||n.addEventListener("click",i),e.addEventListener("click",o=>{o.target===e&&i()}),t.appendChild(e);try{const o=await M.getTicket(this.ticketId);o.data&&this.renderTicketDetail(e,o.data)}catch(o){const a=e.querySelector("#detail-content-body");a&&(a.innerHTML=`
    ...
    `;const r=M.hasRole("ADMIN");n.innerHTML=`
      <div class="flex items-center gap-2">
    ...
    `,n.querySelectorAll("[data-new-status-val]").forEach(a=>{a.addEventListener("click",async()=>{const r=a.getAttribute("data-new-status-val");if(r)try{await M.changeTicketStatus(t.id,r),O.success(`Caso #${t.id} actualizado a ${r}`),n.remove(),e.remove(),this.onStatusChanged()}catch(l){O.error(l.message||"Error al cambiar estado.")}})}),(o=n.querySelector("#close-status-popup"))==null||o.addEventListener("click",()=>n.remove()),i.appendChild(n)}confirmDelete(t,e){var o,a;const i=document.getElementById("modal-container");if(!i)return;const n=document.createElement("div");n.className="fixed inset-0 z-60 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-fade-in",n.innerHTML=`
    ...
    `,(o=n.querySelector("#cancel-delete-btn"))==null||o.addEventListener("click",()=>n.remove()),(a=n.querySelector("#confirm-delete-btn"))==null||a.addEventListener("click",async()=>{try{await M.deleteTicket(t.id),O.success(`Caso #${t.id} eliminado correctamente.`),n.remove(),e.remove(),this.onDelete()}catch(r){O.error(r.message||"Error al eliminar el caso.")}}),i.appendChild(n)}}class Ud{constructor(t){x(this,"container");this.container=t}render(){this.container.innerHTML=`
