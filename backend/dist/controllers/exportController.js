...
async function exportExcel(req, res) {
    try {
        ...
        logger_1.logger.error('Error al exportar a Excel', { error: error.message, stack: error.stack });
...
async function exportCsv(req, res) {
    try {
        ...
        logger_1.logger.error('Error al exportar CSV', { error: error.message, stack: error.stack });
