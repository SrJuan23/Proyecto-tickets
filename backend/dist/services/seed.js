...
async function seedDatabase() {
    ...
    const supportPass = await bcryptjs_1.default.hash('agente123', 10);
    ...
    for (const t of ticketData) {
        const res = await db_1.db.run(`INSERT INTO tickets (prioridad, cliente_id, asunto, descripcion, plataforma_id, solicitante, fecha_creacion, servicenow, turno, estado, fecha_actualizacion, fecha_cierre, tiempo_atencion_minutos)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [
